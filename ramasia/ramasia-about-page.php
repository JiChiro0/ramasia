...
<head>
  ...
  <link rel="stylesheet" href="./css/ramasia-about-page.css">
...
<body>
  ...
  <section class="hero">
    <div class="hero-content">
      <h1>About Us</h1>
      <div class="hero-logo-placeholder">RAMASIA</div>
    </div>
  </section>

  <!-- =========================== INFO SECTION (History, Vision, Mission) =========================== -->
  <section class="info-section">
    <div class="info-grid">
      ...
      <div class="info-box">
        <h2>History</h2>
        <p>
          RAMASIA aims to process and deploy its recruits in an expeditions and timely manner in order to minimize costs; at the same time, ensure the quality of recruits through systematic sourcing and stringent quality testing of applicants.
        </p>
        <p class="quote">"PROFESSIONALS WORKING WITH PROFESSIONALS"</p>
      </div>

      <!-- Vision + Mission Stacked Column -->
      <div class="info-box stacked">
        <div class="vision">
          <h3 class="label red-bg">VISION</h3>
          <p>To be the most preferred overseas manpower agency by clients and the Filipino workforce for its exceptional services.</p>
        </div>

        <div class="mission">
          <h3 class="label red-bg">MISSION</h3>
          <p>To provide our clients with highly qualified people and to give Filipinos better opportunities to work.</p>
          <p class="values">CORE VALUES. INTEGRITY. ETHICS. DEDICATION. TEAM WORK.</p>
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="about-main">
    <div class="content-container">
      <h2><span class="highlight"></span>Ramasia International Manpower Services, Inc.</h2>
      <div class="about-grid">
        <!-- Image on the left -->
        <div class="about-image">
          <img src="../image-source/" alt="Ramasia Team">
        </div>
        <!-- Text on the right -->
        <div class="about-text">
          <p>
            Started its operations in 1999 and is licensed by the Department of Migrant Workers (former POEA) on to recruit and deploy all types of land-based workers for overseas under the POEA License No. 078-LB052820-R.
          </p>
          <p>
            In the course of more than seventeen years operation, Ramasia had deployed thousands of professional workers to different countries all over the world. Ramasia is presently involved in deploying professionals including nurses, caregivers, teachers, computer programmers, web designers & developers plus other skilled workers to the USA, United Kingdom, Middle East & Asian Countries.
          </p>
          <p>
            Its core services lie in the recruitment of qualified candidates to the US and specialized nurses to the UK. Thousands of Philippines workers have been successfully recruited to work in school districts located in New York, California, Arizona, Texas, North Carolina, New Mexico, Maryland, and many other states.
          </p>
        </div>
      </div>
    </div>
  ...
  <section class="president-message">
    <div class="content-container">
      <div class="president-grid">
        ...
        <div class="president-text">
          ...
          <p>
            My dedication and commitment as a CEO and President of Ramasia International Manpower Services Inc. with 23 Years of experience in supplying Highly Qualified Filipinos for Overseas Employment, licensed by the Philippine Overseas Employment Administration (POEA) and now Department of Migrant Workers (DMW) which Ranked 2 in terms of deployment among the Top 200 recruitment agencies in the Philippines, to keep our business as strong as our people.
          </p>
          <p>
            I’m immensely proud of what we have achieved, and looking forward to its continued success. Our recruitment infrastructure is well-established in all major cities in the Philippines and over the years, we have earned a reputation for serving our clients across Gulf Countries , Orientals and extending to Europe and Canada with continuously increased productivity, faster deployment, and superior personnel.
          </p>
          <p>
            Here, I would like to extend my gratitude to our experienced People working behind the success of our company. On behalf of the entire team, we are professionals working with professionals and we welcome you in pursuing your dreams.
          </p>
          <p class="signature">
            <strong>Best Regards,</strong><br>
            <span class="name">Dominga D. Brun</span><br>
        ...
        <div class="president-image">
          <div class="president-image-container">
            <img src="Ramasia President.png" alt="President Dominga D. Brun">
            <div class="president-overlay">
    ...
    <div class="president-quote">
      <p class="quote-text">
        "Nothing worthwhile comes easily. Work, continuous work and hard work, is the only way to accomplish results that last." <br>– Hamilton Holt
      </p>
      <p class="quote-sub">
        "Success comes from taking THE INITIATIVE AND FOLLOWING UP…PERSISTING…WHAT SIMPLE ACTION COULD YOU TAKE TODAY TO PRODUCE a new momentum toward success in YOUR LIFE?" – Tony Robbins On behalf of the entire team, we are professionals working with professionals and we welcome you in pursuing your dreams.
        </p>
      </div>
    </div>
  </section>
      ...
      <div class="footer-content">
        ...
        <div class="footer-column footer-main">
          <div class="footer-logo">
            <img src="transparent-ramasialogo-navbar.png" alt="Ramasia Logo" class="footer-logo-img">
          </div>
          <p class="footer-description">
            Ramasia International Man Power Services Inc. has been connecting skilled professionals with global opportunities since 1999. Licensed by the Department of Migrant Workers.
          </p>
        ...
        <div class="footer-column">
          ...
          <div class="footer-contact">
            ...
            <div class="contact-item">
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
                <path d="M0 4a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v8a2 2 0 0 1-2 14H2a2 2 0 0 1-2-2zm2-1a1 1 0 0 0-1 1v.217l7 4.2 7-4.2V4a1 1 0 0 0-1-1zm13 2.383-4.708 2.825L15 11.105zm-.034 6.876-5.64-3.471L8 9.583l-1.326-.795-5.64 3.47A1 1 0 0 0 2 13h12a1 1 0 0 0 .966-.741M1 11.105l4.708-2.897L1 5.383z"/>
              </svg>
